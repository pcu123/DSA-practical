...
# 1. Binning: Categorize mpg into Low, Medium, High( converts continues data into categories)
...
mtcars$wt_normalized <- (mtcars$wt - min(mtcars$wt)) /   #normalization formula 
...
mtcars$power_to_weight <- mtcars$hp / mtcars$wt #power:weight ratio formula
